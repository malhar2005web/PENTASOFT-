      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mb-16">
          ...
          <p className="mt-4 text-slate-300 text-base sm:text-lg leading-relaxed">
            PentaSoft Consultancy brings deep technical domain expertise to build software systems that solve complex operational bottlenecks. We combine strategic design with clean, high-performance code to power enterprise digital transformation.
          </p>
        </div>
