...
export default function Navbar() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const sections = ['home', 'what-we-do', 'who-we-serve', 'contact'];
        ...
        <div className="flex items-center justify-between">
          ...
          <a href="#home" className="flex items-center space-x-3.5 group">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-[10px] font-mono text-neutral-700 tracking-wider font-bold">PCS // SYSTEMS & ARCHITECTURE</span>
            </div>
          </a>

          {/* Clean 3-Item Navigation */}
          <nav className="hidden md:flex items-center space-x-1.5 px-3.5 py-1.5 rounded-full liquid-glass-pill">
            {navLinks.map((link) => (
              <a
                key={link.id}
                href={link.href}
